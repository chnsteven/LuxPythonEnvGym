...
def train(args):
    ...
    # opponent = AgentPolicy(mode="inference", model=MaskablePPO.load("../baseline/PPO_5/model.zip"))
    opponent = Agent()
    ...
    if args.path:
        ...
        model = MaskablePPO.load(args.path)
    ...
    if args.n_envs > 1:
        ...
        callbacks.append(
            MaskableEvalCallback(env_eval, best_model_save_path=f'./logs_{run_id}/',
    ...
    for i in range(600):
        ...
        action_code, _states = model.predict(
